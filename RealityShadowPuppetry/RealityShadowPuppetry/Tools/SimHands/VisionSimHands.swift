...
//        debugPrint("scale:\(scale)")
    ...
    func convertToHandVector(offset: simd_float3) -> (left: simd_float4x4?, right: simd_float4x4?) {
        var leftVector: simd_float4x4?
        var rightVector: simd_float4x4?
